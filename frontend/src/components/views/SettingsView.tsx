          ...
          <div className="space-y-4 p-4 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <div>
              ...
              >
                ...
                <option value="Method 1: Spatial Bounding-Box Layout Clustering + PP-OCRv4 (Recommended #1)">Method 1: Spatial Bounding-Box Layout Clustering + PP-OCRv4 (Local)</option>

                <option value="Method 2: OpenCV Morphological Grid Line Cleaning + Cell Isolation">Method 2: OpenCV Morphological Grid Line Cleaning + Cell Isolation (Local)</option>
                <option value="Method 3: Local Compact Vision Model (Florence-2-base / Qwen2-VL)">Method 3: Local Compact Vision Model (Florence-2 / Ollama)</option>
                <option value="Camelot Lattice">Camelot Lattice (Table Grids)</option>
                <option value="Camelot Stream">Camelot Stream (Borderless Tables)</option>
                <option value="pdfplumber Tables">pdfplumber Tables</option>
                <option value="pdfplumber Words (Spatial)">pdfplumber Words (Spatial)</option>
                <option value="Tabula">Tabula Engine</option>
